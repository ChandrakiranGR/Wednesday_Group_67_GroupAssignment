...
public class ViewOrderItemDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewOrderItemDetailJPanel(JPanel userProcessContainer, OrderItem item) {
        ...
        txtProductName.setText(item.getSelectedProduct().getName());
        txtProductId.setText(String.valueOf(item.getSelectedProduct().getTargetPrice()));
        txtSalesPrice.setText(String.valueOf(item.getActualPrice()));
        txtQuantity.setText(String.valueOf(item.getQuantity()));
        txtTotal.setText(String.valueOf(item.getQuantity()*item.getActualPrice()));
